...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="tmux_alr"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/arthur/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/arthur/.mailcheckrc"
# }
...
# now_playing.sh {
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/home/arthur/.now_playing.log"
...
# time.sh {
	...
	# Use TZ Identifier like "America/Los_Angeles"
	 export TMUX_POWERLINE_SEG_TIME_TZ="Europe/Paris"
# }

# tmux_continuum_save.sh {
	# Path to the tmux-continuum git repo.
	export TMUX_POWERLINE_SEG_TMUX_CONTINUUM_PATH="/home/arthur/.tmux/plugins//tmux-continuum"
# }
...
#vpn.sh {
	...
	# Colour for vpn tunnel symbol
	 export TMUX_POWERLINE_SEG_VPN_SYMBOL_COLOUR=#72F1B8
