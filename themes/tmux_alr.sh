...
TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR=#181521
TMUX_POWERLINE_DEFAULT_BACKGROUND_1_COLOR=#D95988
TMUX_POWERLINE_DEFAULT_BACKGROUND_2_COLOR=#3F528C
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR=#72F1B8
...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		...
		"hostname $TMUX_POWERLINE_DEFAULT_BACKGROUND_1_COLOR $TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR"
		#"mode_indicator 165 0"
		#"ifstat 30 255"
		#"ifstat_sys 30 255"
		"lan_ip  $TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR $TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR"
		"vpn  $TMUX_POWERLINE_DEFAULT_BACKGROUND_1_COLOR $TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR"
		#"wan_ip 24 255"
		#"vcs_branch 29 88"
		#"vcs_compare 60 255"
		#"vcs_staged 64 255"
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		#"earthquake 3 0"
		"pwd $TMUX_POWERLINE_DEFAULT_BACKGROUND_2_COLOR $TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR"
		...
		"date_day $TMUX_POWERLINE_DEFAULT_BACKGROUND_2_COLOR $TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR"
		"date  $TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR $TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR"
		"time $TMUX_POWERLINE_DEFAULT_BACKGROUND_2_COLOR $TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR"
		#"utc_time #3F528C 136 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
	)
fi
